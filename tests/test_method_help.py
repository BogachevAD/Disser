...
class MethodHelpTests(unittest.TestCase):
    ...
    def test_project_readme_contains_extractable_help_section(self):
        ...
        self.assertIn("#### Происхождение коэффициента 1,4826", markdown)
        self.assertIn("#### Происхождение квантили 0,6827", markdown)
        self.assertIn(r"1.48260222\,MAD", markdown)
        self.assertIn(r"Q_{0.682689}(|B-\mu|)=\sigma", markdown)
