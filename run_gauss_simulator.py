...
# FIT_METHOD выбирает один из четырёх методов: обычный/робастный
# Нелдер–Мид и каждый из них с квадрантной предобработкой.
# BACKGROUND_RING_GAP отделяет хвосты ФРТ от фоновой рамки,
